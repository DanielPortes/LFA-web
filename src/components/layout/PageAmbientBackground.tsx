...
const AMBIENT_PRESETS: Record<Tab, AmbientPreset> = {
    home: {
        light: {
            intensity: 0.58,
            base: 'linear-gradient(180deg, #ecf5ff 0%, #e4efff 44%, #eef5ff 100%), radial-gradient(circle at 14% 16%, rgba(116, 188, 255, 0.18), transparent 32%), radial-gradient(circle at 84% 18%, rgba(128, 236, 255, 0.14), transparent 28%)',
            mesh: 'radial-gradient(circle at 14% 18%, rgba(67, 149, 255, 0.36), transparent 34%), radial-gradient(circle at 82% 17%, rgba(76, 224, 255, 0.28), transparent 32%), radial-gradient(circle at 52% 80%, rgba(132, 161, 255, 0.22), transparent 38%)',
            veil: 'linear-gradient(180deg, rgba(255, 255, 255, 0.22) 0%, rgba(255, 255, 255, 0.08) 36%, rgba(237, 245, 255, 0.04) 100%)',
            orbA: 'radial-gradient(circle at 50% 50%, rgba(70, 145, 255, 0.46) 0%, rgba(70, 145, 255, 0.22) 34%, rgba(70, 145, 255, 0) 68%)',
            orbB: 'radial-gradient(circle at 50% 50%, rgba(73, 221, 255, 0.38) 0%, rgba(73, 221, 255, 0.18) 34%, rgba(73, 221, 255, 0) 68%)',
            orbC: 'radial-gradient(circle at 50% 50%, rgba(123, 155, 255, 0.3) 0%, rgba(123, 155, 255, 0.12) 34%, rgba(123, 155, 255, 0) 70%)',
            sheen: 'linear-gradient(122deg, rgba(255, 255, 255, 0) 24%, rgba(255, 255, 255, 0.28) 49%, rgba(255, 255, 255, 0.06) 58%, rgba(255, 255, 255, 0) 76%)',
            vignette: 'radial-gradient(circle at 50% 14%, rgba(255, 255, 255, 0.12), transparent 40%), linear-gradient(180deg, rgba(250, 253, 255, 0) 0%, rgba(231, 240, 252, 0.12) 100%)',
            flash: 'radial-gradient(circle at 50% 50%, rgba(255, 255, 255, 0.3), rgba(255, 255, 255, 0) 62%)',
            motionMesh: 36,
            motionSheen: 28,
            motionA: 30,
            motionB: 36,
        ...
        dark: {
            ...
            mesh: 'radial-gradient(circle at 14% 18%, rgba(43, 129, 255, 0.28), transparent 38%), radial-gradient(circle at 82% 18%, rgba(29, 198, 255, 0.18), transparent 35%), radial-gradient(circle at 52% 82%, rgba(92, 116, 255, 0.16), transparent 42%)',
            veil: 'linear-gradient(180deg, rgba(7, 16, 29, 0.16) 0%, rgba(8, 17, 30, 0.32) 40%, rgba(8, 15, 27, 0.56) 100%)',
            orbA: 'radial-gradient(circle at 50% 50%, rgba(41, 138, 255, 0.4) 0%, rgba(41, 138, 255, 0.18) 34%, rgba(41, 138, 255, 0) 68%)',
            orbB: 'radial-gradient(circle at 50% 50%, rgba(24, 214, 255, 0.28) 0%, rgba(24, 214, 255, 0.12) 34%, rgba(24, 214, 255, 0) 68%)',
            orbC: 'radial-gradient(circle at 50% 50%, rgba(95, 122, 255, 0.22) 0%, rgba(95, 122, 255, 0.08) 34%, rgba(95, 122, 255, 0) 70%)',
            sheen: 'linear-gradient(120deg, rgba(143, 219, 255, 0) 24%, rgba(143, 219, 255, 0.18) 49%, rgba(83, 151, 255, 0.08) 58%, rgba(143, 219, 255, 0) 76%)',
            ...
            flash: 'radial-gradient(circle at 50% 50%, rgba(165, 220, 255, 0.2), rgba(165, 220, 255, 0) 60%)',
            motionMesh: 40,
            motionSheen: 30,
            motionA: 32,
            motionB: 38,
