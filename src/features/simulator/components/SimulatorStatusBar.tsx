...
export const SimulatorStatusBar: React.FC<SimulatorStatusBarProps> = ({
    ...
    const shouldShowStatus = simulationStatus === 'accepted' || simulationStatus === 'rejected' || hasSimulationProgress;
    const statusLabel = simulationStatus === 'accepted'
        ? 'Aceito'
        : simulationStatus === 'rejected'
            ? 'Rejeitado'
            : 'Rodando';
    const statusClassName = simulationStatus === 'accepted'
        ? 'badge-success'
        : simulationStatus === 'rejected'
            ? 'badge-danger'
            : 'badge-accent';
