        ...
        <div className="space-y-2">
            ...
            {isPda && (
                <div className="glass-panel px-5 py-3 rounded-2xl text-[11px] font-medium text-secondary flex items-start gap-3 shadow-apple-sm border border-default bg-surface-1/50 backdrop-blur-md">
                    ...
                    <p>
                        AP: <code className="font-black bg-black/5 dark:bg-white/10 px-1.5 py-0.5 rounded text-ios-purple">símbolo, topo -&gt; novos</code>.
                        A pilha aparece em Visualização; o topo fica destacado no alto e ε indica não consumir ou não empilhar.
                    </p>
                </div>
            )}
        </div>
